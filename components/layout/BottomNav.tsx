...
export const BottomNav: React.FC = () => {
  ...
  return (
    <>
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-[#090e1a] rounded-t-3xl p-5 shadow-2xl border-t border-slate-200 dark:border-slate-800 max-h-[85vh] flex flex-col transition-all">
          {/* Drawer Header */}
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-[#000000]/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800/80 px-3 py-1.5 shadow-lg">
