...
export const Header: React.FC<HeaderProps> = ({ title, onOpenQuickAdd }) => {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/60 dark:bg-[#000000]/60 backdrop-blur-2xl backdrop-saturate-150 border-b border-slate-200/60 dark:border-white/10 px-3 sm:px-8 py-3.5 flex items-center justify-between w-full max-w-full overflow-x-hidden box-border">
