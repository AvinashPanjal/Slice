...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Dialog */}
      <div
        className={`relative w-full ${widthClasses} max-w-[calc(100vw-1rem)] bg-white dark:bg-[#070708] border border-slate-200 dark:border-[#1f1f23] rounded-3xl p-3.5 sm:p-6 shadow-2xl z-10 my-auto mb-16 sm:mb-auto max-h-[82vh] sm:max-h-[90vh] flex flex-col box-border overflow-hidden`}
      >
